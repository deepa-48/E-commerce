  ...
  <div class="row">
    <div class="col-2">
      <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="11.png" width="350px" id="ProductImg">
      <div class="small-img-row">
        <div class="small-img-col">
          <img src="6.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="7.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="8.png" width="100px" class="smallimg">
        </div>
        <div class="small-img-col">
          <img src="9.png" width="100px" class="smallimg">
        </div>
        <div class="small-img-col">
          <img src="10.png" width="100px" class="smallimg">
        </div>
      </div>
    </div>
    <div class="col-2">
      ...
      <h1> Wrist Watch </h1>
      <h4><i class="fa fa-inr">1800.00</i></h4>
       <div class="rating">
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Wrist Watch">
