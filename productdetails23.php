  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="65.png" width="350px" id="ProductImg">
      <div class="small-img-row">
        <div class="small-img-col">
          <img src="66.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="67.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="65.png" width="100px" class="smallimg">
        </div>
      </div>
    </div>
    <div class="col-2">
      <p>Men's Kurta</p>
      <h1>Black Kurta For Men</h1>
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Black Kurta For Men">
      <input type="hidden" name="price" value="399.00">
      <h3>Product Details <i class="fa fa-indent"></i></h3>
      <br>
      <p>
         Ideal For :- Men<br>
         Length Type :- Short<br>
         Brand Color :- Black<br>
         Occasion :- Festival & Part<br>
         Pattern :- Solid<br>
         Type :- Trail Cut<br>
