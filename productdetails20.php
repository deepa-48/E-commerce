  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="48.png" width="350px" id="ProductImg">
      <div class="small-img-row">
        <div class="small-img-col">
          <img src="49.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="50.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="48.png" width="100px" class="smallimg">
        </div>
      </div>
    </div>
    <div class="col-2">
      ...
      <h1> Formal Shoes</h1>
      <h4><i class="fa fa-inr">700.00</i></h4>
       <div class="rating">
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Formal Shoes">
