  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="86.png" width="350px" id="ProductImg">
      <div class="small-img-row">
        <div class="small-img-col">
          <img src="87.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="88.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="86.png" width="100px" class="smallimg">
        </div>
      </div>
    </div>
    <div class="col-2">
      ...
      <br>
      <p>
         Age Group :- 15+ Years<br>
         Beginner,Intermediate,Recreational Playing Level<br>
         Bat Grade :- Grade 1<br>
         Sport Type :- Cricket<br>
         Witn Cover<br>
         Weight Range 900-1150 g
      </p>
    </div>
  </form>
    </div>
