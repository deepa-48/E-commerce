  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="41.png" width="350px" id="ProductImg">
      <div class="small-img-row">
        <div class="small-img-col">
          <img src="42.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="43.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="44.png" width="100px" class="smallimg">
        </div>
      </div>
    </div>
    <div class="col-2">
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Sandal">
