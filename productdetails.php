  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="51.png" width="350px" id="ProductImg">
      <div class="small-img-row">
        <div class="small-img-col">
          <img src="52.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="53.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="54.png" width="105px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="55.png" width="100px" class="smallimg">
        </div>
      </div>
    </div>
    <div class="col-2">
      <p>Party / Crop Top</p>
      <h1>Black Crop Top</h1>
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Black Crop Top">
      ...
      <p>
        Neck :- High Neck<br>
          ...
          Febric :- Georgette Chiffon Blend<br>
