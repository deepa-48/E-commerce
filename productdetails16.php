  ...
  <div class="row">
    <div class="col-2">
      <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="36.png" width="350px" id="ProductImg">
      </div>
    </div>
    <div class="col-2">
      <p>128 inchs Teddy</p>
      <h1> Pink Teddy Bear</h1>
      <h4><i class="fa fa-inr">120.00</i></h4>
       <div class="rating">
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Pink Teddy Bear">
