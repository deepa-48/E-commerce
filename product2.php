...
<head>
  ...
  <meta name="viewport" content="width=device-width, intial-scale=1.0">
	<title>All Products-Classy Fashion</title>
...
<div class="small-container">
  <div class="row row-2">
    ...
    <div class="row">
     ...
     <div class="col-4">
      <a href="productdetails19.php"><img src="45.png"></a>
      <h4>Shoes For men</h4>
      <div class="rating">
       <i class="fa fa-star"></i>
       <i class="fa fa-star"></i>
     ...
     <div class="col-4">
      <a href="productdetails20.php"><img src="48.png"></a>
      <h4> Formal Shoes</h4>
      <div class="rating">
       <i class="fa fa-star"></i>
       <i class="fa fa-star"></i>
      ...
      <p><i class="fa fa-inr">700.00</i></p>
    </div>
      <div class="col-4">
     ...
     <div class="col-4">
      <a href="productdetails23.php"><img src="65.png"></a>
      <h4>Black Kurta For Men</h4>
      <div class="rating">
       <i class="fa fa-star"></i>
       <i class="fa fa-star"></i>
       <i class="fa fa-star"></i>
