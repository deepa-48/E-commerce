  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="1.png" width="350px" id="ProductImg">
      <div class="small-img-row">
        <div class="small-img-col">
          <img src="2.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="3.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="4.png" width="100px" class="smallimg">
        </div>
        <div class="small-img-col">
          <img src="5.png" width="100px" class="smallimg">
        </div>
      </div>
    </div>
    <div class="col-2">
      <p>Fastrack Watch For Girls</p>
      <h1> Girls Watch</h1>
      <h4><i class="fa fa-inr">1500.00</i></h4>
       <div class="rating">
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Girls Watch">
...
<div class="small-container">
     ...
     <div class="col-4">
      <a href="productdetails18.php"><img src="42.png"></a>
      <h4> Sandal</h4>
      <div class="rating">
       <i class="fa fa-star"></i>
       <i class="fa fa-star"></i>
     ...
     <div class="col-4">
       <a href="productdetails21.php"><img src="56.png"></a>
      <h4> Red-Shirt For Girls</h4>
      <div class="rating">
       <i class="fa fa-star"></i>
       <i class="fa fa-star"></i>
       <i class="fa fa-star"></i>
