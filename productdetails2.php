  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="h.jpg" width="350px" id="ProductImg">
    </div>
    <div class="col-2">
      <p>Party / Crop Top</p>
      <h1> Beautiful Red Top </h1>
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Beautiful Red Top ">
      <input type="hidden" name="price" value="500.00">
      <h3>Product Details <i class="fa fa-indent"></i></h3>
      <br>
      <p>Give Your Summer Vardrobe a Style Upgrade With The HRX Girl's Active Crop Top.This Looks Good In Party And Outlook.Both Style Are Good. They Style Your Dressup nice. 
      </p>
    </div>
  </form>
    </div>
