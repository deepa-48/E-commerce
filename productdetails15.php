  ...
  <div class="row">
    <div class="col-2">
      <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="30.png" width="350px" id="ProductImg">
      <div class="small-img-row">
        <div class="small-img-col">
          <img src="31.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="32.png" width="180px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="30.png" width="100px" class="smallimg">
        </div>
      </div>
    </div>
    <div class="col-2">
      <p>Cute & Simple Gift</p>                                       
      <h1>Message Box</h1>
      <h4><i class="fa fa-inr">350.00</i></h4>
       <div class="rating">
     ...
     Quantity<input type="number" value="1" name="Quantity">
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Message Box">
      <input type="hidden" name="price" value="350.00">
      <h3>Product Details <i class="fa fa-indent"></i></h3>
      <br>
      <p>
         Beautiful Message Bottle With Wooden Box,Send a surprise Message to your Special one on Birthday,Anniversary,Valentine's Day,Karwa Chauth and any other occasion. 7 Message Bottle for can be used to put 7 promise to your sepecial one on any special day or 7 dates ideas,7 destination you want to travel with them. The most affordable and fashionable gift to your beloved - spouse,fiance,girlfriend.A beautiful gift to every age Group.
      </p>
    </div>
  </form>
    </div>
...
<div class="small-container">
     ...
     <div class="col-4">
      ...
      <div class="col-4">
      <a href="productdetails17.php"><img src="38.png"></a>
      <h4> Shoes For Girls</h4>
      <div class="rating">
       <i class="fa fa-star"></i>
       <i class="fa fa-star"></i>
       <i class="fa fa-star"></i>
      ...
      <p><i class="fa fa-inr">399.00</i></p>
    </div>
    </div>
    </div>  
</div>
