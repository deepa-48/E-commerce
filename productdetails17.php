  ...
  <div class="row">
    <div class="col-2">
      <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="38.png" width="350px" id="ProductImg">
      <div class="small-img-row">
        <div class="small-img-col">
          <img src="39.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="40.png" width="180px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="38.png" width="100px" class="smallimg">
        </div>
      </div>
    </div>
    <div class="col-2">
      <p>Pink Shoes</p>
      <h1>Shoes For Girls</h1>
      <h4><i class="fa fa-inr">399.00</i></h4>
       <div class="rating">
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Shoes For Girls">
      <input type="hidden" name="price" value="399.00">
      <h3>Product Details <i class="fa fa-indent"></i></h3>
      <br>
      <p>
          Color :- Pink<br>
          Other Material :- Synthetic Leather<br>
          Occasion :- Casual<br>
          Closure :- Lace-Ups<br>
          Upper Pattern :- Printed<br>
          Sales Package :- Pair of one shoes
      </p>
    </div>
  </form>
    </div>
...
<div class="small-container">
     ...
     <div class="col-4">
      <a href="productdetails22.php"><img src="59.png"></a>
      <h4> White-Shirt For Girls</h4>
      <div class="rating">
       <i class="fa fa-star"></i>
       <i class="fa fa-star"></i>
       <i class="fa fa-star"></i>
