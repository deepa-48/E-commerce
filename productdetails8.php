  ...
  <div class="row">
    <div class="col-2">
      <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="73.png" width="350px" id="ProductImg">
      <div class="small-img-row">
        <div class="small-img-col">
          <img src="74.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="75.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="73.png" width="100px" class="smallimg">
        </div>
      </div>
    </div>
    <div class="col-2">
      <p>Long Kurti</p>
      <h1> Stylish Kurti </h1>
      <h4><i class="fa fa-inr">450.00</i></h4>
       <div class="rating">
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Stylish Kurti">
      <input type="hidden" name="price" value="450.00">
      <h3>Product Details <i class="fa fa-indent"></i></h3>
      <br>
      <p>
          Pattern :- Floral Print<br>
          Febric :- Poly Georgette<br>
          Sleeve Length :- No Sleeve<br>
          Type :- Trail Cut<br>
          Pattern :- Solid<br>
          Pack Of :- 1
      </p>
