  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="g.jpg" width="350px" id="ProductImg">
    </div>
    <div class="col-2">
      <p>Stylish / Bow Top</p>
      <h1> Cool Bow Top </h1>
      <h4><i class="fa fa-inr">400.00</i></h4>
       <div class="rating">
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value=" Cool Bow Top">
      <input type="hidden" name="price" value="400.00">
      <h3>Product Details <i class="fa fa-indent"></i></h3>
      <br>
      <p>Neck :- Pussy Bow Collar<br>
          Sleeve Style :- Puff Sleeve<br>
          Febric :- Poly Crepe<br>
