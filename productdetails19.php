  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="45.png" width="350px" id="ProductImg">
      <div class="small-img-row">
        <div class="small-img-col">
          <img src="46.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="47.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="45.png" width="100px" class="smallimg">
        </div>
      </div>
    </div>
    <div class="col-2">
