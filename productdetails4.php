  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="j.jpg" width="350px" id="ProductImg">
    </div>
    <div class="col-2">
      <p>Stylish / Crop Top</p>
      <h1> Crop Top </h1>
      <h4><i class="fa fa-inr">600.00</i></h4>
      <div class="rating">
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value=" Crop Top">
      <input type="hidden" name="price" value="600.00">
      <h3>Product Details <i class="fa fa-indent"></i></h3>
      <br>
      <p>
          Sleeve Style :- Normal<br>
