  ...
  <div class="row">
    <div class="col-2">
      <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="37.png" width="350px" id="ProductImg">
    </div>
    <div class="col-2">
      <p>4 feet Soft Toy</p>
      <h1> Panda Soft Toy </h1>
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Panda Soft Toy">
      ...
      <p>
        ...
        Sound Support :- No<br>
        Washable :- Yes<br>
        Minimum Age :- 4 Years<br>
        Filing Material :- Soft Fiber<br>
