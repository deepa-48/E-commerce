  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="t.jpg" width="350px" id="ProductImg">
      <p>Cool Jacket</p>
      <h1> Jacket For Men </h1>
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Jacket For Men">
      <input type="hidden" name="price" value="300.00">
      <h3>Product Details <i class="fa fa-indent"></i></h3>
      <br>
      <p>
        *Care Instruction :- Regural Machine Wash<br>
        *Fit Type :- Slim Fit<br>
        *Trendy and Stylish Men Jacket<br>
        *Solid Pattern and Stylish Collar<br>
        *Suitable For All Occasions<br>
        *Item Dimensions L*W*H :- 23*26*3<br> 
      </p>
    </div>
  </form>
    </div>
