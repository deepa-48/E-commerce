...
<div class="container">
  <div class="navbar">
  	...
  	<a href="cart.php"><img src="b.jpg" width="30px" height="30px" class="m">
  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="89.png" width="350px" id="ProductImg">
      <p>Outdoor Game</p>
      <h1> Cricket Ball </h1>
      <h4><i class="fa fa-inr">250.00</i></h4>
       <div class="rating">
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Cricket Ball">
      <input type="hidden" name="price" value="250.00">
      <h3>Product Details <i class="fa fa-indent"></i></h3>
      <br>
      <p>
        *Cricket Leather Ball<br>
        *Water Resistant<br>
        *Core Material Cork<br>
        *Weight 450-500 g <br>
        *Suitable for :- Hard<br>
        *Sales Package :- 6 Balls
      </p>
    </div>
  </form>
    </div>
