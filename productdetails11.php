  ...
  <div class="row">
    <div class="col-2">
      <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="76.png" width="350px" id="ProductImg">
      <div class="small-img-row">
        <div class="small-img-col">
          <img src="77.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="78.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="76.png" width="100px" class="smallimg">
        </div>
      </div>
    </div>
    <div class="col-2">
      <p>Basketball</p>
      <h1>Nivia Engraver-7 Basketball</h1>
      <h4><i class="fa fa-inr">520.00</i></h4>
       <div class="rating">
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Nivia Engraver-7 Basketball">
      ...
      <p>
          *Basketball<br>
          *Water Resistant<br>
          *Outer Material Rubber<br>
          *Weight :- 650-700 g<br>
          *Suitable for Wooden Flooring & Indoor Synthetic<br> 
