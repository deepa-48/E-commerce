  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="12.png" width="350px" id="ProductImg">
      <div class="small-img-row">
        <div class="small-img-col">
          <img src="13.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="14.png" width="100px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="12.png" width="105px" class="smallimg">
        </div>
         <div class="small-img-col">
          <img src="13.png" width="100px" class="smallimg">
        </div>
    ...
    <div class="col-2">
      <p>Wrist Watch</p>
      <h1> Fastrack Analog Digital Watch </h1>
      <h4><i class="fa fa-inr">3000.00</i></h4>
       <div class="rating">
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Fastrack Analog Digital Watch">
