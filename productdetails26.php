  ...
  <div class="row">
    <div class="col-2">
       <form action="manage_cart.php" method="post">
        <div class="cart">
      <img src="79.png" width="350px" id="ProductImg">
      </div>
    </div>
    <div class="col-2">
      <p>Indoor Game</p>
      <h1>Carrom Board</h1>
      <h4><i class="fa fa-inr">598.00</i></h4>
       <div class="rating">
      ...
      <button type="submit" class="bdn" name="add_to_cart">Add to cart</button>
       ...
       <input type="hidden" name="item_name" value="Carrom Board">
      <input type="hidden" name="price" value="598.00">
      <h3>Product Details <i class="fa fa-indent"></i></h3>
      <br>
      <p>
          Pack of :- 1<br>
          Sport Type :- Carrom<br>
          Surface Material :- Wooden<br>
